...
class transmit_power(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "transmit_power")
...
def main(top_block_cls=transmit_power, options=None):
